...
var _require2 = require("../services/pass_details.service"),
  getAllPasses = _require2.getAllPasses;
...
router.get('/getallpasses', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          console.error('Pass retrieval error:', _context.t0);
          res.status(500).json({
            status: false,
